# CAI 인공지능 만들기: 단계별 가이드

본 문서를 따라하면 자신만의 LLM을 처음부터 직접 구현하고 학습시킬 수 있습니다.

---

## 개요

**CAI(Contact AI)**는 전 세계 연락처 정보 생성에 특화된 LLM을 만드는 학습 프로젝트입니다.

### 활용 예시

> 필리핀 마닐라에서 긴급 상황 발생 → 한국 대사관이 휴일로 닫혀있음 → 영사 콜센터나 긴급 연락처가 필요함

이런 상황에서 공공 연락처 정보를 제공하는 LLM입니다.
...
`data/raw.txt`에 원본 연락처 데이터를 준비합니다.
